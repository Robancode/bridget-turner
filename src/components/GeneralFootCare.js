      ...
      <Row>
        <Col>
          <Container fluid className='border-top'>
            <h2 className='py-4 text-center'>Foot Facts</h2>
          </Container>
            ...
            <Row className='py-5 justify-content-center'>
              <Col xs={12} md={4}>
                ...
                <p>
                  ...
                  Each foot has 40 joints and 31 muscles; 12 of which are found
                  in the lower leg.
                </p>
                <h4>Function</h4>
                <p>
                  There are two main functions of the feet: to act as a flexible
                  support to the legs and body; and to act as a rigid lever to
                  help propel the body forward when walking.
                </p>
              </Col>
              <Col xs={12} md={4}>
                <h4>Blood supply</h4>
                <p>
                  There are two pulses found in each foot, one on the top of the
                  foot and the other just behind the inside ankle. This is
                  because there are 2 major arteries supplying the feet. There
                  are however 3 main veins to return blood back to the heart, as
                  the blood has to be forced against gravity all the way back.
                </p>
                <p>
          ...
          <Container fluid className='p-4'>
            <Row className='justify-content-center'>
              <Col xs={12} md={4}>
                <h4>Problems</h4>
                <p>
                  Problems with the muscles, joints and bones can cause changes
                  to the surface soft tissues, such as bunions, corns and
                  calluses, and nail disorders.
                </p>
                ...
                <p>
                  ...
                  joints cause stress to other structures in the foot as well as
                  the knees, hips and back. A biomechanical assessment and
